...
from Data_Preprocessing_NLP_Day_7 import remove_lines,expand_text,accented_char,clean_data,lemmatization,join_list
import pickle
#-----------------------------------Importing libraries
...
#-----------------------------------Config data
count_model = pickle.load(open('models/count2_1.pkl', 'rb'))

model = pickle.load(open('models/model2_1.pkl', 'rb'))
